...
faq:
  - question: "Is TurboTax really worth the premium price over FreeTaxUSA?"
    answer: "For simple returns (W-2 only, standard deduction, no investment sales) the answer is no — FreeTaxUSA produces an identical filing for free federal plus 14.99 dollars state. For complex returns (rental property, K-1 income, self-employment, large capital gains) TurboTax's import features and accuracy-support policies deliver real value that justifies the 100 to 200 dollar premium. The break-even is roughly Schedule C income, multiple investment accounts with 1099-B forms, or itemized deductions."
